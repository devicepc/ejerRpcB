...
//  ejercicio 1
const btnPartesprocejer1 = document.getElementById("btnTipProcej7");
...
//  ejercicio 3
/* let indice_aleatorio = Math.floor(Math.random()*PregCpuFallas3.length);
document.getElementById("pregFallasproc").innerHTML =PregCpuFallas3[indice_aleatorio];
let respuestas_prosibles = respCpuFallas[indice_aleatorio];
let txt_resp ="";
for(i in respuestas_prosibles){
    txt_resp += '<button class="alinks" >'+respuestas_prosibles[i]+'</button>';
    
}
document.getElementById("respejer21").innerHTML = txt_resp; */
//console.log("casa"+txt_resp);
// ejercicio 3
